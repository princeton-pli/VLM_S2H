...
class SeparatorStyle(Enum):
    ...
    PLAIN = auto()
    LLAMA_2 = auto()
    LLAMA_3 = auto() ### (COPIED FROM CAMBRIAN CODEBASE)
...
class Conversation:
    ...
    def get_prompt(self):
        ...
        elif self.sep_style == SeparatorStyle.LLAMA_3: ### (COPIED FROM CAMBRIAN CODEBASE)
...
### (COPIED AND ADAPTED FROM CAMBRIAN CODEBASE)
...
conv_templates = {
    ...
    "llava_llama_3": conv_llava_llama_3, ### (COPIED AND ADAPTED FROM CAMBRIAN CODEBASE)
