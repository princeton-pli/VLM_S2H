...
default_cfgs = generate_default_cfgs({
    ...
    'convnext_xxlarge.clip_laion2b_soup_ft_in1k': _cfg(
        hf_hub_id='timm/',
        # hf_hub_id='/scratch/gpfs/juhyunp/models/convnext_xxlarge.clip_laion2b_soup_ft_in1k',
        mean=OPENAI_CLIP_MEAN, std=OPENAI_CLIP_STD,
        input_size=(3, 256, 256), pool_size=(8, 8), crop_pct=1.0),
    ...
    'convnext_xxlarge.clip_laion2b_soup': _cfg(
        ...
        hf_hub_id='/scratch/gpfs/juhyunp/models/CLIP-convnext_xxlarge-laion2B-s34B-b82K-augreg-soup',
        hf_hub_filename='open_clip_pytorch_model.bin',
        mean=OPENAI_CLIP_MEAN, std=OPENAI_CLIP_STD,
