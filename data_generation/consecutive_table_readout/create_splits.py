...
def image2answer_text_cot(d):
    template = "<image>\n\nThe image shows the sales data of different products in different months. For readability, values in the cells have been replaced by their English names, e.g. 0 is represented by ZERO. There is a path of highlighted cells (colored in yellow), that moves along rows of the table either left to right or right to left, starting from START_CELL and ending at END_CELL. Please return the total of all values in the highlighted cells. Provide the final answer as 'Answer: [total]'."
