...
seed=$(( 150 + (nrow - 8) * 10 + (ncol - 8) * 2 + tot_objs ));
...
# Second step is to generate SIMPLE_eval and HARD_eval samples by rejection sampling
# SIMPLE_eval
num_data=500
output_dir="../../synthetic_data/grid_navigation"
dis_split_='SIMPLE_eval'
...
# Third step is to generate images for the created SIMPLE_eval and HARD_eval split
# SIMPLE_eval
max_objs=2
n_obstacles='1'
output_dir="../../synthetic_data/grid_navigation"
